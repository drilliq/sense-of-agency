...
function ExperimentAW() {
  ...
  return (
    <div>
      ...
      {whiteNoise1 && (
        <ExperimentWhiteNoise callback={whiteNoiseCallback1} recognition={recognition} />
      )}
      ...
      {whiteNoise2 && (
        <ExperimentWhiteNoise callback={whiteNoiseCallback2} recognition={recognition} />
      )}
